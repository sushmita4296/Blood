    ...
    <header class="dashboard_header">
		<nav>
          ...
          <!--  <li><a href="<?php echo base_url('dashboard/entrepreneurpost/postview_controller');?>">Entrepreneur post</a></li> -->
           <li><a href="<?php echo base_url('dashboard/post/postview_controller');?>">Blood Seeker post</a></li>
					<li><a href="<?php echo base_url('dashboard/jobseekerinfo'); ?>">Blood Donor info</a></li>
					<li><a href="<?php echo base_url('dashboard/jobproviderinfo'); ?>">Blood Seeker  info</a></li>
