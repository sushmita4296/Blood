					...
					<nav>
						<div class="top_menu_seeker">
							...
							<li><a href="<?php echo base_url('jbseeker_dashboard_controller/jbseeker_dashboard'); ?>">Dashboard</a></li>
          					<li><a href="<?php echo base_url('jbseeker_dashboard_controller/post/postview_controller');?>">Current Blood Posts</a></li>
							<li><a href="<?php echo base_url('jbseeker_dashboard_controller/Jobproviderinfo'); ?>">Blood Seeker's Info</a></li>
