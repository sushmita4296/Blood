	    		...
	    		<div class="col-lg-10">
					<nav>
						...
						<div class="top_menu_provider">
							<ul>
								<li><a href="<?php echo base_url('provider_dashboard_controller/post_controller/job_post_controller'); ?>">Create Post</a></li>
								<li><a href="<?php echo base_url('provider_dashboard_controller/own_post_controller/view_own_post'); ?>">Own post</a></li>
								<li><a href="<?php echo base_url('provider_dashboard_controller/jobseekerinfo'); ?>">Blood Donor's Info</a></li>
