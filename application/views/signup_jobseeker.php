        ...
        <div class="jbseekerform">
          <form method="post" action="<?php echo base_url("jbseeker_dashboard_controller/Register/validation"); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="single-info">
                  <label for="Permanentaddress">Blood Group</label>
                   <input class="mb25" type="text" name="Permanentaddress" placeholder="Enter Blood Group" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="single-info">
                  <label for="skill">Profession</label>
                   <input class="mb25" type="text" name="skill" placeholder="Enter your Profession" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="single-info">
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="button-design">
                     <div class="row">
                      <div class="col-lg-6">
                         <button class="btn btn-primary w-100 h-100" type="button" class="cancelbtn">Cancel</button>
                      </div>
                      <div class="col-lg-6">
