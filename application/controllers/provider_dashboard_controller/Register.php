...
class Register extends CI_Controller {
 ...
 public function __construct()
 {
  ...
  $this->load->model('provider_dashboard_model/register_model');
 }
 ...
 function validation()
 {
      ...
      //////////////extra end
        ...
        if($id > 0)
        {
          ...
          <p>This is email verification mail from Codeigniter Login Register system. For complete registration process and login into system. First you want to verify you email by click this <a href='".base_url()."provider_dashboard_controller/register/verify_email/".$verification_key."'>link</a>.</p>
 ...
 function verify_email()
 {
  if($this->uri->segment(4))
  {
   ...
   {
    $data['message'] = '<h1 align="center">Your Email has been successfully verified, now you can login from <a href="'.base_url().'Jobprovider/provider">here</a></h1>';
   }
   else
   {
    $data['message'] = '<h1 align="center">Invalid Link</h1>';
   }
   $this->load->view('provider_dashboard_view/email_verification', $data);
  }
 }
