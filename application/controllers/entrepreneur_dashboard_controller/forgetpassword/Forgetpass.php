...
class Forgetpass extends CI_Controller {
	function __construct(){
		...
		// }
		$this->load->model('entrepreneur_dashboard_model/forgetpassword/forgetpass_model');
	...
	public function index()
	{
		...
		$this->load->view('entrepreneur_dashboard_view/forgetpassword/forgetpass');
		// $this->load->view('provider_dashboard_view/sidebar');
		// $this->load->view('footer');
	}
	public function reset(){
		 $email = $this->input->post('email');
		$result = $this->db->get_where('entrepreneur',array('email'=>$email))->row();
		...
		if($result){
			...
			$message = "Please click on password reset link <br><a href='".base_url()."entrepreneur_dashboard_controller/forgetpassword/forgetpass/verify/".$token."/".$email."'>Reset Password</a>
			<p>token:".$token."</p>";
			...
			$config = array(
			    ...
			    if($this->email->send())
			    {
				 ...
				 redirect('entrepreneur_dashboard_controller/forgetpassword/forgetpass');
	...
	public function verify(){
		// echo
		 ...
		 // echo $token;
		 $this->load->view('header');
		 $this->load->view('entrepreneur_dashboard_view/forgetpassword/recoverpass_form',$data);
	}
